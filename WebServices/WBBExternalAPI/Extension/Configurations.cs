...
namespace WBBExternalAPI.Extension
{
    internal class Configurations
    {
        ...
        public static IConfigurationRoot GetContext
        {
            get
            {
                ...
                var builder = new Microsoft.Extensions.Configuration.ConfigurationBuilder().SetBasePath(appPath).AddJsonFile("appsettings.json", optional: false, reloadOnChange: true);
