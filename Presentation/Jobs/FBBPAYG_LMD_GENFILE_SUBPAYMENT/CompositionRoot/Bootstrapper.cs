...
namespace FBBPAYG_LMD_GENFILE_SUBPAYMENT.CompositionRoot
{
    using FBBPAYG_LMD_GENFILE_SUBPAYMENT.Code;
    using FBBPAYG_LMD_GENFILE_SUBPAYMENT.CrossCuttingConcerns;
