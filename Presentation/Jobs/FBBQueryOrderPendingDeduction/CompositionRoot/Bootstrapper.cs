using FBBQueryOrderPendingDeduction.Code;
using FBBQueryOrderPendingDeduction.CrossCuttingConcerns;
using SimpleInjector;
using WBBBusinessLayer;
using WBBContract;

namespace FBBQueryOrderPendingDeduction.CompositionRoot
{
