...
namespace FBBInventoryResendPendingSAPS4.CompositionRoot
{
    using FBBInventoryResendPendingSAPS4.Code;
    using FBBInventoryResendPendingSAPS4.CrossCuttingConcerns;
