...
namespace FBBPAYGCheckLoadFileALLToTable.CompositionRoot
{
    using FBBPAYGCheckLoadFileALLToTable.Code;
    using FBBPAYGCheckLoadFileALLToTable.CrossCuttingConcerns;
