...
namespace AutoCreateFolderNas
{
    ...
    public class FBBAutoCreateFolderNasBatchJob
    {
        ...
        public FBBAutoCreateFolderNasBatchJob(
            ILogger logger,
        ...
        public bool AutoCreateFolderNas()
        {
                    ...
                    if (Directory.Exists(destNAS))
                    {
                        ...
                        for (int i = 1; i <= 12; i++)
                        {
                            ...
                            if (!Directory.Exists(FullPath))
                            {
                                ...
                                _logger.Info("AutoCreateFolderNas :" + FolderName);
                        ...
                        _logger.Info("AutoCreateFolderNas SuccessFull !!!");
                        return true;
                    }
                    else
                    {
            ...
            {
                _outErrorResult = "Error AutoCreateFolderNas : " + ex.GetErrorMessage();
                _logger.Info("Error AutoCreateFolderNas : " + ex.GetErrorMessage());
