...
namespace RPAEquipmentReplenishmentToSub.CompositionRoot
{
    using RPAEquipmentReplenishmentToSub.Code;
    using RPAEquipmentReplenishmentToSub.CrossCuttingConcerns;
