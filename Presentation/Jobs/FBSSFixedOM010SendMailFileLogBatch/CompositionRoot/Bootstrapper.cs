using FBSSFixedOM010SendMailFileLogBatch.Code;
using FBSSFixedOM010SendMailFileLogBatch.CrossCuttingConcerns;
using SimpleInjector;
using WBBBusinessLayer;
using WBBContract;

namespace FBSSFixedOM010SendMailFileLogBatch.CompositionRoot
{
