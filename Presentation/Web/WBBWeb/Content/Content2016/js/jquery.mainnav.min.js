...
function ais_interface_process(loadtheme, loadsite, loadlanguage, loadfile, loadLangButton) {
    var RootDoc = document.domain;
    if (loadlanguage == 'en') {
        $("#aisfooter").html(footerscript);
        //});
...
function closepopmenu(language) {
    $(".menu_popup").hide();
    //alert(language);
    if (language == 'en') {
        $(".search-eservice").val('Mobile Number');
    }
    else if (language == 'th') {
