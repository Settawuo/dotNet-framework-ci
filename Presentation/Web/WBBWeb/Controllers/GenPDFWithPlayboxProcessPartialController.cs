...
namespace WBBWeb.Controllers
{
    ...
    {
        public string GeneratePDF_PlayboxOnly(
            QuickWinPanelModel model,
            string directoryPath,
            string directoryTempPath,
            string fileName)
        {
            try
            {
                    ...
                    foreach (var l in ListEntity)
                    {
                        ...
                        else
                        {
                            ...
                            else if ((l.Name.Equals("L_SUMM_DETAIL11")))//
                            {
                                ...
                                var sum1 = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_LABEL_FULLHD;
                                var deatal2 = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_FULLHD;
                                if (sum1 != null && sum1 != "")
                                {
                                    table.Rows.Add(numberx, "", deatal2, sum1, unit, "", ""); numberx += 1;
                                }
                                else
                                {
                                    table.Rows.Add(numberx, "", "", "", "", "", ""); numberx += 1;
                ...
                using (MemoryStream myMemoryStream = new MemoryStream())
                {
                    ...
                    //BaseFont bf = BaseFont.CreateFont(@"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\fonts\tahoma.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
                    ...
                    iTextSharp.text.Font fntPBL = new iTextSharp.text.Font(bf, 6f, Font.BOLD);
                    ...
                    for (int x = 1; x <= 2; x++)
                    {
                        ...
                        //iTextSharp.text.Image pdfbg = iTextSharp.text.Image.GetInstance(@"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\src\BG_base1.jpg");
                        ...
                        //iTextSharp.text.Image pdflogo = iTextSharp.text.Image.GetInstance(@"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\src\img-logo.png");
                        ...
                        if (SiteSession.CurrentUICulture.IsThaiCulture())
                        {
                            ...
                            //imgStatus = @"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\src\thai_5.png";
                        }
                        else
                        {
                            imgStatus = "~/Content/src/eng_5.png";
                            //imgStatus = @"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\src\eng_5.png";
                        }
                        ...
                        for (int row = 0; row < table.Rows.Count; row++)
                        {
                            ...
                            if (Convert.ToInt32(id_) == (55 + extendedContentRow) && displayType_ == "R")
                            {
                                document.Add(pdfbg);
                                document.Add(pdflogo);
                                document.Add(pdfstatus);
                            ...
                            else if (Convert.ToInt32(id_) == (54 + extendedContentRow) && displayType_ != "R")
                            {
                                document.Add(pdfbg);
                                document.Add(pdflogo);
                                document.Add(pdfstatus);
                            ...
                            if (displayType_ == "R") /// space
                            {
                                ...
                                /// 18 line ของ free tv ที่เป็นว่าง
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1") /// มี pbl
                                {
                                    if ((id_ == "2")
                                        || (id_ == "3")
                                        || (id_ == "10")
                                        ...
                                        || (id_ == (52 + extendedContentRow).ToSafeString())
                                        || (id_ == (53 + extendedContentRow).ToSafeString())
                                        || (id_ == (54 + extendedContentRow).ToSafeString())
                                        //|| (id_ == (57 + extendedContentRow).ToSafeString())
                                        )
                                    {
                                        continue;
                                    }
                            ...
                            else
                            {
                                ...
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1") /// มี pbl
                                {
                                    if ((id_ == "2")
                                        || (id_ == "3")
                                        || (id_ == "10")
                                        || (id_ == (35 + extendedContentRow).ToSafeString())
                                        || (id_ == (44 + extendedContentRow).ToSafeString())
                                        || (id_ == (45 + extendedContentRow).ToSafeString())
                                        || (id_ == (53 + extendedContentRow).ToSafeString())
                                        || (id_ == (61 + extendedContentRow).ToSafeString())
                                        //|| (id_ == (66 + extendedContentRow).ToSafeString())
                                        )
                                    {
                                        continue;
                                    }
                                ...
                                )
                            {
                                ...
                                if (id_ == (15 + extendedContentRow).ToSafeString())
                                {
                                    PdfPCell.BorderColorBottom = borderCoolor;
                                    PdfPCell.BorderColorRight = borderCoolor;
                                    PdfPCell.BorderColorTop = borderCoolor;
                            ...
                            if (x == 1)
                            {
                                    ...
                                    || (!string.IsNullOrEmpty(val_5.Trim())))
                                {
                                    ...
                                    if ((id_ == "13")
                                        ...
                                        || (id_ == (15 + mainPackContentExtend).ToSafeString())
                                    ...
                                    {
                                        if ((id_ == (20 + mainPackContentExtend).ToSafeString()) || (id_ == EndPack))
                                        {
                                        ...
                                        if (val_1 != "hasBorder")
                                        {
                                            ...
                                            {
                                                if (id_ == (18 + mainPackContentExtend).ToSafeString()
                                                    && SiteSession.CurrentUICulture.IsEngCulture())
                                                {
                                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), fntPBL))); PdfPCell.FixedHeight = fixedHeight;
                                                }
                                                else
                                                {
                                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), fntbold))); PdfPCell.FixedHeight = fixedHeight;
                                        ...
                                        PdfTable.AddCell(PdfPCell);
                                            ...
                                            || (id_ == (24 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (25 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (26 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (28 + extendedContentRow).ToSafeString())
                                            || (id_ == (29 + extendedContentRow).ToSafeString())
                                            || (id_ == (30 + extendedContentRow).ToSafeString())
                                            || ((extendedContentRow > 0 && id_ == "30"))
                                            || (id_ == (32 + extendedContentRow).ToSafeString())
                                            || (id_ == (33 + extendedContentRow).ToSafeString())
                                            )
                                    {
                                        if ((id_ == (22 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (23 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (24 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (25 + mainPackContentExtend).ToSafeString())
                                            || (id_ == (26 + mainPackContentExtend).ToSafeString())
                                        ...
                                        if (id_ == (33 + extendedContentRow).ToSafeString())
                                        {
                                            PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), fntbold))); PdfPCell.FixedHeight = fixedHeight;
                                        }
                                        else
        ...
        public string GeneratePDF_PlayboxOnly_Line2(
            QuickWinPanelModel model,
            string directoryPath,
            string directoryTempPath,
            string fileName)
                    ...
                    foreach (var l in ListEntity)
                    {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    continue;//table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", ""); numberx += 1;
                                }
                                else if (l.Name.Equals("L_SUMM_DETAIL_WireBB"))
                                {
                                    continue;
                                ...
                                else if ((l.Name.Equals("L_MULTI_PLAYBOX_INITIATIONS")))
                                {
                                    table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", ""); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_SUMM_DETAIL6")))//
                ...
                using (MemoryStream myMemoryStream = new MemoryStream())
                {
                    ...
                    for (int x = 1; x <= 2; x++)
                    {
                        ...
                        if (SiteSession.CurrentUICulture.IsThaiCulture())
                        {
                            ...
                            //imgStatus = @"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\images\vas\statusTH-03.png";
                        }
                        else
                        {
                            imgStatus = "~/Content/images/vas/statusEN-03.png";
                            //imgStatus = @"D:\Outsource\TFS\FBB.Web\FBB.Web-Branch-Dev\Presentation\Web\WBBWeb\Content\images\vas\statusEN-03.png";
                        }
                        ...
                        for (int row = 0; row < table.Rows.Count; row++)
                        {
                            ...
                            if (Convert.ToInt32(id_) == 54 && displayType_ == "R")
                            {
                                document.Add(pdfbg);
                                document.Add(pdflogo);
                                document.Add(pdfstatus);
                            ...
                            else if (Convert.ToInt32(id_) == 60 && displayType_ != "R")
                            {
                                document.Add(pdfbg);
                                document.Add(pdflogo);
                                document.Add(pdfstatus);
                            ...
                            if (displayType_ == "R") /// space
                            {
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1")
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "26") || (id_ == "29") ||
                                         (id_ == "34") || (id_ == "42") || (id_ == "43") || (id_ == "44") || (id_ == "45") || (id_ == "46") || (id_ == "47")
                                        || (id_ == "48") || (id_ == "35") || (id_ == "36") || (id_ == "37") || (id_ == "38") || (id_ == "39") || (id_ == "40"))
                                    {
                                        continue;
                                    }
                                }
                                ...
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "16") || (id_ == "26") || (id_ == "29") ||
                                         (id_ == "34") || (id_ == "42") || (id_ == "43") || (id_ == "44") || (id_ == "45") || (id_ == "46") || (id_ == "47")
                                        || (id_ == "48") || (id_ == "35") || (id_ == "36") || (id_ == "37") || (id_ == "38") || (id_ == "39") || (id_ == "40"))
                                    {
                                        continue;
                            ...
                            else
                            {
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1")
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "26") || (id_ == "29") || (id_ == "34") || (id_ == "42") || (id_ == "50")
                                        || (id_ == "51") || (id_ == "52") || (id_ == "53") || (id_ == "54") || (id_ == "38") || (id_ == "39") || (id_ == "40") || (id_ == "41") || (id_ == "42"))
                                    {
                                        continue;
                                    }
                                }
                                ...
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "16") || (id_ == "26") || (id_ == "29") || (id_ == "34") || (id_ == "42") || (id_ == "50")
                                        || (id_ == "51") || (id_ == "52") || (id_ == "53") || (id_ == "54") || (id_ == "38") || (id_ == "39") || (id_ == "40") || (id_ == "41") || (id_ == "42"))
                                    {
                                        continue;
                                    }
                            ...
                            ////// record ที่เป็นหัวรายการของแต่ละอัน
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && ((id_ == "17") || (id_ == "21")))
                            {
                                PdfPCell.BorderColorBottom = borderCoolor;
                                PdfPCell.BorderColorLeft = borderCoolor;
                                PdfPCell.BorderColorTop = borderCoolor;
                            ...
                            if (x == 1)
                            {
                                ...
                                {
                                    /// record ที่มี ค่าเดียว ใน package
                                    if ((id_ == "13") || (id_ == "14") | (id_ == "15") || (id_ == "16") || (id_ == EndPack) || ((Convert.ToInt32(id_) > startDoc)))
                                    {
                                        if ((id_ == EndPack))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 45f, 10f, 10f, 10f, 10f });
                                        ...
                                        if (val_1 != "hasBorder")
                                        {
                                            ...
                                            if (id_ == "14" || id_ == "15" || id_ == "16")
                                            {
                                                if (id_ == "16" && SiteSession.CurrentUICulture.IsEngCulture())
                                                {
                                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), fntPBL))); PdfPCell.FixedHeight = fixedHeight;
                                                }
                                                else
                                    ...
                                    else if ((id_ == "5") || (id_ == "6") || (id_ == "7") || (id_ == "8") || (id_ == EndInfo) || (id_ == "18") || (id_ == "19") || (id_ == "20") || (id_ == "22") || (id_ == "23") || (id_ == "24"))
                                    {
                                        if ((id_ == "18") || (id_ == "19") || (id_ == "20") || (id_ == "22") || (id_ == "23") || (id_ == "24"))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 35f, 10f, 10f, 10f, 10f });
                                        }
                                        if ((id_ == EndInfo))
        ...
        public string GeneratePDF_Playbox(
            QuickWinPanelModel model,
            string directoryPath,
            string directoryTempPath,
            string fileName)
                ...
                using (MemoryStream myMemoryStream = new MemoryStream())
                {
                    ...
                    for (int x = 1; x <= 2; x++)
                    {
                        ...
                        for (int row = 0; row < table.Rows.Count; row++)
                        {
                            ...
                            else if (Convert.ToInt32(id_) == 57 && displayType_ != "R")
                            {
                                document.Add(pdfbg);
                                document.Add(pdflogo);
                                document.Add(pdfstatus);
                            ...
                            if (displayType_ == "R") /// space
                            {
                                if (model.CoveragePanelModel.PRODUCT_SUBTYPE == "FTTx" && (id_ == "21"))
                                {
                                    continue;
                                }
                                /// line 19 ที่เป็นค่าว่าง ของ free TV
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1")
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "40") || (id_ == "48") ||
                                     (id_ == "11") || (id_ == "62"))
                                    {
                                        continue;
                                    }
                            ...
                            else
                            {
                                ...
                                if (model.SummaryPanelModel.PackageModel.SelectPlayPBL_Flag == "1")
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "40") || (id_ == "48") || (id_ == "49") || (id_ == "57")
                                    || (id_ == "64") || (id_ == "72"))
                                    {
                                        continue;
                                    }
                                ...
                                {
                                    if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "19") || (id_ == "40") || (id_ == "48") || (id_ == "49") || (id_ == "57")
                                    || (id_ == "64") || (id_ == "72"))
                                    {
                                        continue;
                                    }
                            ...
                            ////// record ที่เป็นหัวรายการของแต่ละอัน
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && ((id_ == "20") || (id_ == "22") || (id_ == "30") || (id_ == "35")))
                            {
                                PdfPCell.BorderColorBottom = borderCoolor;
                                PdfPCell.BorderColorLeft = borderCoolor;
                                PdfPCell.BorderColorTop = borderCoolor;
                            ...
                            if (x == 1)
                            {
                                ...
                                {
                                    /// record ที่มี ค่าเดียว ใน package
                                    if ((id_ == "13") || (id_ == "14") | (id_ == "15") || (id_ == "16") || (id_ == "17") || (id_ == "18") || (id_ == "19") || (id_ == "21") || (id_ == EndPack) || ((Convert.ToInt32(id_) > startDoc)))
                                    {
                                        if ((id_ == "21") || (id_ == EndPack))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 45f, 10f, 10f, 10f, 10f });
                                        }
                                        ...
                                        if (val_1 != "hasBorder")
                                        {
                                            ...
                                            if (id_ == "17" || id_ == "18" || id_ == "19")
                                            {
                                                if (id_ == "19" && SiteSession.CurrentUICulture.IsEngCulture())
                                                {
                                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), fntPBL))); PdfPCell.FixedHeight = fixedHeight;
                                                }
                                                else
                                    ...
                                    else if ((id_ == "5") || (id_ == "6") || (id_ == "7") || (id_ == "8") || (id_ == EndInfo) || (id_ == "23") || (id_ == "24") || (id_ == "25") || (id_ == "26") || (id_ == "27") || (id_ == "28") || (id_ == "29") || (id_ == "31") || (id_ == "32") || (id_ == "33") || (id_ == "34") || (id_ == "36") || (id_ == "37"))
                                    {
                                        if ((id_ == "23") || (id_ == "24") || (id_ == "25") || (id_ == "26") || (id_ == "27") || (id_ == "28") || (id_ == "29") || (id_ == "31") || (id_ == "32") || (id_ == "33") || (id_ == "34") || (id_ == "36") || (id_ == "37"))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 35f, 10f, 10f, 10f, 10f });
                                        }
                                        if ((id_ == EndInfo))
        ...
        public string GeneratePDF_PlayboxFixline_Line2(
            QuickWinPanelModel model,
            string directoryPath,
            string directoryTempPath,
            string fileName)
                ...
                using (MemoryStream myMemoryStream = new MemoryStream())
                {
                    ...
                    for (int x = 1; x <= 1; x++)
                    {
                        ...
                        for (int row = 0; row < table.Rows.Count; row++)
                        {
                            ...
                            //if (Convert.ToInt32(id_) == 48 && displayType_ != "R")
                            //{
                            //    document.NewPage();
                            //    document.Add(pdfbg);
                            //    document.Add(pdflogo);
                            ...
                            if (displayType_ == "R") /// space
                            {
                                if ((id_ == "2") || (id_ == "3") || (id_ == "17") || (id_ == "32") || (id_ == "35") || (id_ == "39") || (id_ == "41") || (id_ == "42") || (id_ == "43") || (id_ == "44") || (id_ == "45") || (id_ == "46") ||
                                     (id_ == "10") || (id_ == "48") || (id_ == "49") || (id_ == "50") || (id_ == "51") || (id_ == "52")
                                    || (id_ == "53") || (id_ == "54"))
                                {
                                    continue;
                                }
                            ...
                            {
                                if ((id_ == "2") || (id_ == "3") || (id_ == "10") || (id_ == "17") || (id_ == "32") || (id_ == "35") || (id_ == "40") ||
                                    (id_ == "43") || (id_ == "44") || (id_ == "45") || (id_ == "46") || (id_ == "47")
                                    || (id_ == "56") || (id_ == "57") || (id_ == "58") || (id_ == "59") || (id_ == "60"))
                                {
                                    continue;
                                }
                            }
                            ...
                            ////// record ที่เป็นหัวรายการของแต่ละอัน
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && ((id_ == "18") || (id_ == "24") || (id_ == "27")))
                            {
                                PdfPCell.BorderColorBottom = borderCoolor;
                                PdfPCell.BorderColorLeft = borderCoolor;
                                PdfPCell.BorderColorTop = borderCoolor;
                            ...
                            if (x == 1)
                            {
                                ...
                                {
                                    /// record ที่มี ค่าเดียว ใน package
                                    if ((id_ == "13") || (id_ == "14") || (id_ == "15") || (id_ == "16") || (id_ == "17") || (id_ == EndPack) || ((Convert.ToInt32(id_) > startDoc)))
                                    {
                                        if ((id_ == EndPack))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 35f, 10f, 10f, 10f, 10f });
        ...
        public string GeneratePDF_Multi_PlayboxOnly_Line2(
            QuickWinPanelModel model,
            string directoryPath,
            string directoryTempPath,
            string fileName)
        {
            try
            {
                //model.MulitPlaybox ?? new List<Multiplay

                #region setborder

                var typeHeaderPdf = "HeaderPdf";
                var typeHeaderDetailBox = "HeaderDetailBox";
                var typeHeaderDetail = "HeaderDetail";
                var typeEndInfo = "EndInfo";
                var typeEndPack = "EndPack";
                var typeEndAddressSetup = "EndAddressSetup";
                var typeEndAddressBill = "EndAddressBill";
                var typeEndAddressVat = "EndAddressVat";
                var typeThreeColumn = "ThreeColumn";
                var typeThreeColumnFntbold = "ThreeColumnFntbold";
                var typeThreeColumnEndPack = "ThreeColumnEndPack";
                var typeFourColumn = "FourColumn";
                var typeOntopPack = "OntopPack";
                var typeSpace = "Space";
                ...
                var ListEntity = GetPDFConfig().Where(l => l.GroupByPDF.Contains("0") // && l.GroupByPDF != "02D2" 
                    && l.GroupByPDF != "08H" || l.GroupByPDF == "MULTI_PACK_DETAIL").ToList();
                string item = "";
                ...
                table.Rows.Add(numberx, item, " ", " ", " ", "", "", typeHeaderPdf); numberx += 1;
                ...
                if (type_ != null)
                {
                    ...
                    var selectPlaybox = model.MulitPlaybox.Take(Convert.ToInt32(model.RegisterPlayboxNumber)).ToList();
                    ...
                    foreach (var l in ListEntity)
                    {
                        ...
                        // Check group PDF
                        if (!string.IsNullOrEmpty(groupPDF) && groupPDF != l.GroupByPDF.Substring(0, 2) && l.GroupByPDF != "MULTI_PACK_DETAIL")
                        {
                            chkColumn = true;
                            table.Rows.Add(numberx, " ", " ", " ", " ", "", "", typeSpace); numberx += 1;
                            groupPDF = l.GroupByPDF.Substring(0, 2);
                        }
                        else if (string.IsNullOrEmpty(groupPDF))
                        {
                        ...
                        try
                        {
                            ...
                            if (l.GroupByPDF.Substring(2, 1).Equals("H"))
                            {
                                ...
                                else if (l.Name.Equals("L_BILLING_DETAIL"))// add detail
                                {
                                    ...
                                    table.Rows.Add(numberx, l.DisplayValue, " ", " ", " ", "", "", typeHeaderDetailBox); numberx += 1;
                                    table.Rows.Add(numberx, value, "", "", "", "", "", typeEndAddressBill); numberx += 1;
                                ...
                                else if ((l.Name.Equals("L_VAT_DETAIL")))// add detail
                                {
                                    if (type != "R")
                                    {
                                        ...
                                        table.Rows.Add(numberx, l.DisplayValue, " ", " ", " ", "", "", typeHeaderDetailBox); numberx += 1;
                                        table.Rows.Add(numberx, value, "", "", "", "", "", typeEndAddressVat); numberx += 1;
                                    }
                                }
                                ...
                                else
                                {
                                    ...
                                    if (l.Name.Equals("L_INSTALL_DETAIL"))
                                    {
                                        ...
                                        table.Rows.Add(numberx, value, "", "", "", "", "", typeEndAddressSetup); numberx += 1;
                                    }
                                }
                            ...
                            else
                            {
                                ...
                                else if (l.Name.Equals("L_ONTOP_PACK"))//แพกเกจเสริม
                                {
                                    ...
                                    {
                                        var val = model.SummaryPanelModel.PDFPackageModel.PDF_L_ONTOPLIST.FirstOrDefault() ?? "";
                                        if (!string.IsNullOrEmpty(model.SummaryPanelModel.PDFPackageModel.PDF_L_ONTOPLIST.FirstOrDefault()))
                                        {
                                            table.Rows.Add(numberx, l.DisplayValue, val, "", "", "", "", typeOntopPack); numberx += 1;
                                        }
                                        else
                                        {
                                            continue;
                                ...
                                {
                                    continue;
                                    //table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_MULTI_PLAYBOX_INITIATIONS")))
                                {
                                    //table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;
                                ...
                                else if ((l.Name.Equals("L_SUMM_DETAIL8")))//รวมค่าชำระของ Fixline
                                {
                                    //var sum1 = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_SUM1;

                                    //table.Rows.Add(numberx, "", l.DisplayValue, sum1, unit, "", "", typeThreeColumn); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_ONTOP_PLAYBOX_PRE_INITIATION")))// playbox ค่าติดตั้ง
                                {
                                    continue;
                                ...
                                {
                                    table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;
                                    foreach (var playbox in selectPlaybox)
                                    {
                                        table.Rows.Add(numberx, "", playbox.MonthlyDetaill, DataConvertHelpers.ToStrCurrencyFormatPdf(playbox.MonthlyFee), unit, "", "", typeThreeColumn); numberx += 1;
                                    }
                                }
                                else if ((l.Name.Equals("L_SUMM_DETAIL10")))//
                                {
                                ...
                                else if ((l.Name.Equals("L_SUM_MAINTEN_RATE")))//
                                {
                                    ...
                                    {
                                        var summaintain = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_MAINTAINPHONE;
                                        table.Rows.Add(numberx, "", l.DisplayValue, summaintain, unit, "", "", typeThreeColumn); numberx += 1;
                                    }
                                    else
                                    {
                                        continue;
                                ...
                                else if (l.Name.Equals("L_SUM_DISCOUNT_INSTALL_RATE"))
                                {
                                    ...
                                    {
                                        var disbasephone = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_DISCOUNTBASEPHONE;
                                        table.Rows.Add(numberx, "", l.DisplayValue, disbasephone, unit, "", "", typeThreeColumn); numberx += 1;
                                    }
                                    else
                                    {
                                        continue;
                                ...
                                {
                                    var sum2 = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_SUM2;
                                    table.Rows.Add(numberx, "", l.DisplayValue, sum2, unit, "", "", typeThreeColumn); numberx += 1;
                                    //var sum =
                                    //    selectPlaybox.Sum(
                                    //        fee =>
                                    //            string.IsNullOrEmpty(fee.MonthlyFee)
                                    //                ? 0
                                    //                : Convert.ToDouble(fee.MonthlyFee));
                                    //table.Rows.Add(numberx, "", l.DisplayValue, sum, unit, "", "", typeThreeColumn); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_SUMM_DETAIL12")))//
                                {
                                    table.Rows.Add(numberx, "", l.DisplayValue, "", "", "", "", typeEndPack); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_SUMM_DETAIL13")))//ค่่าบริการเฉลี่ยรายวัน(pro-rate)
                                {
                                    table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;
                                ...
                                {
                                    var val4day = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_4DAY;
                                    table.Rows.Add(numberx, "", l.DisplayValue, val4day, unit, "", "", typeThreeColumn); numberx += 1;
                                }
                                else if ((l.Name.Equals("L_SUMM_DETAIL15")))//
                                {
                                    var firsbillsum = model.SummaryPanelModel.PDFPackageModel.PDF_L_LABEL_DETAIL_ALLFIRSTBILL;
                                    table.Rows.Add(numberx, "", l.DisplayValue, firsbillsum, unit, "", "", typeThreeColumnFntbold); numberx += 1;
                                }
                                else if (l.Name.Equals("L_BUNDLING_DISCOUNT_DTL")
                                            || l.Name.Equals("L_DISCOUNT_DTL"))
                                {
                                ...
                                else if (l.Name.Equals("L_SUM_INSTALL_RATE"))//
                                {
                                    ...
                                    {
                                        var basephone = model.SummaryPanelModel.PDFPackageModel.PDF_L_VALUE_DETAIL_BASEPHONE;
                                        table.Rows.Add(numberx, "", l.DisplayValue, basephone, unit, "", "", typeThreeColumn); numberx += 1;
                                    }
                                    else
                                    {
                                        continue;
                                ...
                                //17.6 multi playbox
                                else if (l.Name.Equals("L_MULTI_PLAYBOX_INITIATIONS_FEE"))
                                {
                                    table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;

                                    foreach (var playbox in selectPlaybox)
                                    {
                                        table.Rows.Add(numberx, "", playbox.InstallDetaill, DataConvertHelpers.ToStrCurrencyFormatPdf(playbox.InstallFee), unit, "", "", typeThreeColumn); numberx += 1;
                                    }
                                }
                                else if (l.Name.Equals("L_MULTI_PLAYBOX_SUMM_DETAIL"))
                                {
                                    var sum =
                                        selectPlaybox.Sum(
                                            fee =>
                                                string.IsNullOrEmpty(fee.InstallFee)
                                                    ? 0
                                                    : Convert.ToDouble(fee.InstallFee));
                                    table.Rows.Add(numberx, "", l.DisplayValue, DataConvertHelpers.ToStrCurrencyFormatPdf(sum), unit, "", "", typeThreeColumn); numberx += 1;
                                }
                                //else if (l.Name.Equals("L_MULTI_PLAYBOX_MONTHLY_FEE"))
                                //{
                                //    table.Rows.Add(numberx, l.DisplayValue, "", "", "", "", "", typeHeaderDetail); numberx += 1;
                                ...
                                //    }
                                //}
                                //else if (l.Name.Equals("L_MULTI_PLAYBOX_ADDITIONAL_MONTHLY_FEE"))
                                //{
                                //    var sum =
                                //        selectPlaybox.Sum(
                                //            fee =>
                                ...
                                //                    ? 0
                                //                    : Convert.ToDouble(fee.MonthlyFee));
                                //    table.Rows.Add(numberx, "", l.DisplayValue, DataConvertHelpers.ToStrCurrencyFormatPdf(sum), unit, "", "", SiteSession.CurrentUICulture.IsThaiCulture() ? typeThreeColumn : typeThreeColumnEndPack); numberx += 1;
                                //}
                                //else if (l.Name.Equals("L_MULTI_PLAYBOX_EXCLUDING_VAT") && !string.IsNullOrEmpty(l.DisplayValue))
                                //{
                                //    table.Rows.Add(numberx, "", l.DisplayValue, "", "", "", "", typeEndPack); numberx += 1;
                                //}
                                ...
                                else
                                {
                                    if (chkColumn == true && l.Name.Equals("L_INSTALLATION_DATE") && (type.ToUpper().Trim() == "B" || type.ToUpper().Trim() == "G"))
                                    {
                                        var installdateb = model.CustomerRegisterPanelModel.L_INSTALL_DATE;
                                        if (installdateb.ToSafeString() == "") installdateb = "-";
                                        table.Rows.Add(numberx, l.DisplayValue, installdateb, "", "", "", "", typeEndInfo); numberx += 1;
                                    }
                                    else
                                    {
                                        if (chkColumn)
                                        ...
                                        else
                                        {
                                            ...
                                            column2 = column2.Replace("วว/ดด/ปปปป(พ.ศ.)", "");
                                            column2 = column2.Replace("dd/mm/yyyy", "");
                                            table.Rows.Add(numberx, column1, Value1, column2, Value2, "", "", l.Name.Equals("L_INSTALLATION_DATE") ? typeEndInfo : typeFourColumn); numberx += 1;
                ...
                using (MemoryStream myMemoryStream = new MemoryStream())
                {
                    ...
                    for (int x = 1; x <= 2; x++)
                    {
                        ...
                        for (int row = 0; row < table.Rows.Count; row++)
                        {
                            PdfTable = new PdfPTable(table.Columns.Count - 2);
                            PdfTable.TotalWidth = 415;
                            //PdfTable.SetWidths(new float[] { 15f, 25f, 10f, 10f, 10f, 10f });
                            string id_ = table.Rows[row].ItemArray[0].ToString();
                            ...
                            string val_4 = table.Rows[row].ItemArray[5].ToString();
                            string val_5 = table.Rows[row].ItemArray[6].ToString();
                            string pdfType = table.Rows[row].ItemArray[7].ToString();

                            //if (pdfType == typeSpace) continue;


                            PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[1].ToString(), fnt))); PdfPCell.FixedHeight = fixedHeight;

                            if ((pdfType == typeEndInfo) || (pdfType == typeEndPack) || (pdfType == typeEndAddressSetup)
                                || (pdfType == typeEndAddressBill) || (pdfType == typeEndAddressVat) || (pdfType == typeThreeColumnEndPack))
                            {
                                if (pdfType == typeEndInfo)
                                {
                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[1].ToString(), fnt1))); PdfPCell.FixedHeight = fixedHeight;
                                    PdfTable.SetWidths(new float[] { 15f, 15f, 0f, 15f, 15f, 0f });
                                }

                                if (pdfType == typeThreeColumnEndPack)
                                {
                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[1].ToString(), fnt1))); PdfPCell.FixedHeight = fixedHeight;
                                    PdfTable.SetWidths(new float[] { 5f, 35f, 10f, 10f, 10f, 10f });
                                }
                                ...
                                if (pdfType == typeEndAddressSetup || (pdfType == typeEndAddressBill) || (pdfType == typeEndAddressVat))
                                {
                                    PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[1].ToString(), fnt1))); PdfPCell.FixedHeight = fixedHeight;
                                    PdfPCell.Colspan = 6;
                                    //PdfTable.SetWidths(new float[] { f, 15f, 0f, 15f, 15f, 0f });
                            ...
                            ////// record ที่เป็นหัวรายการของแต่ละอัน
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && (pdfType == typeHeaderDetail))
                            {
                                PdfPCell.BorderColorBottom = borderCoolor;
                                PdfPCell.BorderColorLeft = borderCoolor;
                                PdfPCell.BorderColorTop = borderCoolor;
                            ...
                            ///// ตัวแรกของ แต่ละกลุ่ม
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && (pdfType == typeHeaderDetailBox || (id_ == startDoc.ToString())))
                            {
                                PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[1].ToString(), fntgreen))); PdfPCell.FixedHeight = fixedHeight;
                                PdfPCell.BorderColorBottom = borderCoolor;
                                PdfPCell.BorderColorLeft = borderCoolor;
                            ...
                            /// หัวตัวแรกสุด ข้อมูลผู้สมัคร
                            else if (!string.IsNullOrEmpty(val_0.Trim()) && ((pdfType == typeHeaderPdf)))
                            {
                                PdfPCell.Border = PdfPCell.NO_BORDER;
                            }
                            else
                            {
                                if (!string.IsNullOrEmpty(val_0.Trim()) && pdfType == typeFourColumn)
                                {
                                    if (id_ == "6")
                                    {
                                        if (val_2.Split(',').Length > 1)
                                    ...
                                    PdfTable.SetWidths(displayType_ == "R"
                                        ? new float[] { 15f, 25f, 0f, 15f, 15f, 0f }
                                        : new float[] { 15f, 15f, 0f, 15f, 25f, 0f });
                                }
                            ...
                            if ((x == 2) || ((string.IsNullOrEmpty(val_1.Trim())) && (string.IsNullOrEmpty(val_2.Trim()))
                                && (string.IsNullOrEmpty(val_3.Trim()) && (string.IsNullOrEmpty(val_4.Trim()))
                                && (string.IsNullOrEmpty(val_5.Trim())))))
                            {
                                if (string.IsNullOrEmpty(val_0.Trim()))
                                {
                                ...
                                else if ((!string.IsNullOrEmpty(val_0.Trim())) && (string.IsNullOrEmpty(val_1.Trim())) && (x == 1)
                                    && ((Convert.ToInt32(id_) > startDoc)))
                                {
                                    PdfPCell.BorderColorBottom = borderCoolor;
                                    PdfPCell.BorderColorRight = borderCoolor;
                            ...
                            if (x == 1)
                            {
                                ...
                                {
                                    /// record ที่มี ค่าเดียว ใน package
                                    if (pdfType == typeEndPack || Convert.ToInt32(id_) > startDoc)
                                    {
                                        if ((pdfType == typeEndPack))
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 45f, 10f, 10f, 10f, 10f });
                                        }
                                        if (val_1 != "hasBorder")
                                        ...
                                        if ((pdfType == typeEndPack) || (id_ == (startDoc + Convert.ToInt16(EndDoc) - 1).ToString()))
                                        {
                                            PdfPCell.BorderWidthBottom = borderSize;
                                        }
                                    ...
                                    else if (pdfType == typeFourColumn || pdfType == typeEndInfo || pdfType == typeThreeColumn
                                        || pdfType == typeThreeColumnEndPack || pdfType == typeThreeColumnFntbold)
                                    {
                                        if ((pdfType == typeEndInfo))
                                        {
                                            PdfTable.SetWidths(new float[] { 15f, 25f, 0f, 15f, 15f, 0f });
                                        ...
                                        if (pdfType == typeThreeColumn || pdfType == typeThreeColumnEndPack || pdfType == typeThreeColumnFntbold)
                                        {
                                            PdfTable.SetWidths(new float[] { 5f, 35f, 10f, 10f, 10f, 10f });
                                        }
                                        ...
                                        PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[2].ToString(), pdfType == typeThreeColumnFntbold ? fntbold : fnt))); PdfPCell.FixedHeight = fixedHeight;

                                        if (pdfType == typeEndInfo || pdfType == typeThreeColumnEndPack)
                                        {
                                            PdfPCell.BorderColorTop = borderCoolor;
                                            PdfPCell.BorderColorLeft = borderCoolor;
                                            PdfPCell.BorderColorRight = borderCoolor;
                                        ...
                                        PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[3].ToString(), pdfType == typeThreeColumnFntbold ? fntbold : fnt))); PdfPCell.FixedHeight = fixedHeight;
                                        ...
                                        PdfPCell = new PdfPCell(new Phrase(new Chunk(table.Rows[row].ItemArray[4].ToString(), pdfType == typeThreeColumnFntbold ? fntbold : fnt))); PdfPCell.FixedHeight = fixedHeight;
