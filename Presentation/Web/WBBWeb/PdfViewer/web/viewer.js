    ...
    (function() {
        ...
        (function(root, factory) {
            ...
            webViewerOpenFileViaURL = function webViewerOpenFileViaURL(file) {
                ...
                if (file && file.lastIndexOf('pdf64', 0) === 0) {
                    console.log("GetPDF data: ");
                    var hostNametmp = window.location.hostname;
	                var protocoltmp = window.location.protocol;
                    var finalUrl = protocoltmp + '//' + hostNametmp + '/Process/GetPDF';
