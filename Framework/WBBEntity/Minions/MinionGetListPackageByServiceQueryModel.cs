...
{
    public class MinionGetListPackageByServiceQueryModel
    {

        //for return
        public decimal o_return_code { get; set; }

        public List<ListPackageModel> ListPackageByServiceList { get; set; }

        public MinionGetListPackageByServiceQueryModel()
        {
            o_return_code = -1;
            ListPackageByServiceList = new List<ListPackageModel>();
        }
    }

    public class ListPackageModel
    {
