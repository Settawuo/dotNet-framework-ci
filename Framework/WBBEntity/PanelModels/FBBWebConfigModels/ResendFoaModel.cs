...
namespace WBBEntity.PanelModels.FBBWebConfigModels
{
    ...
    public class NewRegistFOAResendLog
    {
    ...
    [Serializable]
    public class NewRegistFOAResendLogServiceList
    {
    ...
    [Serializable]
    public class NewRegistFOAResendLogProductList
    {
