...
{
    public class FBSSEntityRepository<T> : FBSSEntityRepositoryBase<T>, IFBSSEntityRepository<T> where T : class
    {
        public FBSSEntityRepository(IFBSSDbFactory dbFactory)
            : base(dbFactory)
        { }
