...
{
    public class FBBHVRDbFactory : IDisposable, IFBBHVRDbFactory
    {
        ...
        public FBBHVRDbFactory()
        {
        }

        public FBBHVRDbFactory(DbConnection conn, string dbSchema)
        {
            _conn = conn;
            _dbSchema = dbSchema;
        }

        public FBBHVRDbFactory(string connString, string dbSchema)
        {
