...
{
    public class SaveEditConfigRulePriorityCommand
    {
        public string Rule_id { get; set; }
        public string Rule_name { get; set; }
        public string Priority { get; set; }
        public string Lookup_name { get; set; }
        public List<Lookup_param_list_Edit> Lookup_param_list_Edit { get; set; }
        public string effective_start { get; set; }
        public string effective_end { get; set; }
        public string Lmr_flag { get; set; }
        public List<Condition_list_Edit> Condition_list_Edit { get; set; }
