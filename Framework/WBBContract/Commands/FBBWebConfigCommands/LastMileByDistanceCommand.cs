...
{
    public class LastMileByDistanceCommand
    {
    }
    public class FBB_access_list
    {
        public string ACCESS_NUMBER { get; set; }
    }
    public class UpdateLastMileByDistanceByOrderCommand
    {
        public List<FBB_access_list> p_ACCESS_list { get; set; }
    ...
    public class SendMailLastMileCommand
    {
        public string p_USER { get; set; }
        public string p_period_from { get; set; }
        public string p_period_to { get; set; }
        public List<FixOrderListTmp> fixed_order { get; set; }
        public int ret_code { get; set; }
        public string ret_msg { get; set; }

    }

    public class LastMileUpdateNoteCommand
    {
        public string p_ACCESS_NO { get; set; }
    ...
    public class LastMileByDistanceUpdateByFileCommand
    {
        public string p_INTERFACE { get; set; }
        public string p_USER { get; set; }
        public string p_STATUS { get; set; }
        public string p_filename { get; set; }
        public List<FBB_update_file_list> p_file_list { get; set; }
        public string ret_code { get; set; }
        public string ret_msg { get; set; }
    }

    public class FBB_update_file_list
    {
    ...
    public class SendMailLastMileNotificationCommand
    {
