...
{
    public class UpdateConfigurationLookupCommand
    {
        public string lookup_name { get; set; }
        public string lookup_ontopflag { get; set; }
        public string lookup_ontop { get; set; }
        public List<LookupDataListUpdate> lookup_list { get; set; }
        public string create_by { get; set; }
        public string modify_by { get; set; }
        public string return_code { get; set; }
        public string return_msg { get; set; }
    }
    public class LookupDataListUpdate
    {
        public string lookup_id { get; set; }
        public string lookup_status { get; set; }
        public List<lookupDataHeaderUpdate> lookup_header_list { get; set; }
    }
    public class lookupDataHeaderUpdate
    {
