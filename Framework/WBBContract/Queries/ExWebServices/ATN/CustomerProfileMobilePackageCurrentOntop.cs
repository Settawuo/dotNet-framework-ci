...
{
    public class CustomerProfileMobilePackageCurrentOntop
    {
        ...
        public string featureStatusDate { get; set; }
        public string featureSubCode { get; set; }
        public string earlyRenewOfferingFlag { get; set; }
        public string firstUseFlag { get; set; }
