...
{
    public class DeleteFileQueryHandler : IQueryHandler<DeleteFileQuery, DeleteFileModel>
    {
        ...
        public DeleteFileQueryHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public DeleteFileModel Handle(DeleteFileQuery query)
        {
            ...
            if (file_owner != null)
            {
                try
                {
                    ...
                    //query.FileName = query.NasType == "REFURBISHED_FBB" ? query.FileName.Replace(query.FileName,cfg.remotePath): query.FileName;
                    resp = sftp.Delete(cfg.UserName, keyfile, cfg.remotePath, query.FileName, cfg.ConfigType, out string msg);
                    ...
                    if (resp.Delete)
                    {
                        try
                        {
                            ...
                            {
                                file_name = Path.GetFileName(query.FileName),
