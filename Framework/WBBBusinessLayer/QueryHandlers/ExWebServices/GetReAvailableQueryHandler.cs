...
{
    public class GetReAvailableQueryHandler : IQueryHandler<GetReAvailableQuery, SBNCheckCoverageResponse>
    {
        ...
        public GetReAvailableQueryHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public SBNCheckCoverageResponse Handle(GetReAvailableQuery query)
        {
