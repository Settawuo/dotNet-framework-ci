...
{
    public class GetCustomerProfileServiceProfileHandler : IQueryHandler<GetCustomerProfileServiceProfileRequest, GetCustomerProfileServiceProfileResult>
    {
        ...
        public GetCustomerProfileServiceProfileHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public GetCustomerProfileServiceProfileResult Handle(GetCustomerProfileServiceProfileRequest query)
        {
            InterfaceLogCommand log = null;
            var result = new GetCustomerProfileServiceProfileResult();
            var success = "";
            var remark = "";
            try
            {
                ...
                var queryContractFbbUrl = _skyLov.GetServiceProfileUrl(query.msisdn);
                ...
                success = "Success";
                result = response?.Content?.JsonToObj<GetCustomerProfileServiceProfileResult>();
            }
            catch (Exception ex)
            {
                success = "Failed";
