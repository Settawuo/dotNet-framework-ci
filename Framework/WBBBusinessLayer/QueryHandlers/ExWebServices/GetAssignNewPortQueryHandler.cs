...
{
    public class GetAssignNewPortQueryHandler : IQueryHandler<GetAssignNewPortQuery, SBNCheckCoverageResponse>
    {
        ...
        public GetAssignNewPortQueryHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public SBNCheckCoverageResponse Handle(GetAssignNewPortQuery query)
        {
