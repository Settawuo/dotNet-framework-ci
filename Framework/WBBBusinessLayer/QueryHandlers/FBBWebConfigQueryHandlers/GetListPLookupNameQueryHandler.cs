...
{
    class GetListPLookupNameQueryHandler : IQueryHandler<GetListPLookupNameQuery, List<GetListPLookupNameModel>>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<GetListPLookupNameModel> _objService;
        private readonly IEntityRepository<FBB_INTERFACE_LOG> _intfLog;
        private readonly IWBBUnitOfWork _uow;

        public GetListPLookupNameQueryHandler(ILogger logger, IEntityRepository<GetListPLookupNameModel> objService,
        ...
        public List<GetListPLookupNameModel> Handle(GetListPLookupNameQuery query)
        {
            ...
            try
            {
                ...
                var executeResult = _objService.ExecuteReadStoredProc(
                    "wbb.pkg_fixed_asset_prioritylookup.p_get_lookup_name",
                    new
                    {
                        return_code,
                        return_msg,
