...
namespace WBBBusinessLayer.QueryHandlers.FBBWebConfigQueryHandlers
{
    ...
    public class SelectProvinceSeachVDSLHandler : IQueryHandler<SelectProvinceVDSLQuery, List<DropdownModel>>
    {
        ...
        public SelectProvinceSeachVDSLHandler(ILogger logger, IEntityRepository<FBB_COVERAGEAREA> FBB_COVERAGEAREA,
        ...
        public List<DropdownModel> Handle(SelectProvinceVDSLQuery query)
        {
            ...
            {
                Zipcode_idListData = (from z2 in ZipcodeID where z2.RegionCode == query.REGION_CODE select z2.ZipcodeID).Distinct().ToList();
