...
{
    class GetRuleLastMileByDistanceQueryHandler : IQueryHandler<GetRuleLastMileByDistanceQuery, List<RuleLastMileByDistanceModel>>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<RuleLastMileByDistanceModel> _objService;

        public GetRuleLastMileByDistanceQueryHandler(ILogger logger, IEntityRepository<RuleLastMileByDistanceModel> objService)
        {
            _logger = logger;
            _objService = objService;
        }

        public List<RuleLastMileByDistanceModel> Handle(GetRuleLastMileByDistanceQuery query)
        {
            try
            {
                ...
                var executeResult = _objService.ExecuteReadStoredProc(
                    "WBB.PKG_FIXED_ASSET_LASTMILE.p_get_rule_id",
                    new
                    {
                        ret_code,
                        ret_msg,
