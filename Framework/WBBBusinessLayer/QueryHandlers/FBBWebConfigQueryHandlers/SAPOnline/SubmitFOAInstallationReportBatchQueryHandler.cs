...
{
    public class SubmitFOAInstallationReportBatchQueryHandler : IQueryHandler<SubmitFOAInstallationReportBatchQuery, List<SubmitFOAInstallation>>
    {
        ...
        public SubmitFOAInstallationReportBatchQueryHandler(
            ILogger logger,
        ...
        public List<SubmitFOAInstallation> Handle(SubmitFOAInstallationReportBatchQuery query)
        {
