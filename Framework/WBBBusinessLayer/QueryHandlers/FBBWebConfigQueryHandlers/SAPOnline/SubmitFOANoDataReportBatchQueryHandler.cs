...
{
    class SubmitFOANoDataReportBatchQueryHandler : IQueryHandler<SubmitFOANoDataReportBatchQuery, List<SubmitFOAEquipment>>
    {
        ...
        public SubmitFOANoDataReportBatchQueryHandler(
            ILogger logger,
        ...
        public List<SubmitFOAEquipment> Handle(SubmitFOANoDataReportBatchQuery query)
        {
            ...
            try
            {
                List<SubmitFOAEquipment> executeResult = _submitEquipmentLog.ExecuteReadStoredProc("WBB.PKG_FIXED_ASSET_LASTMILE.p_get_no_data",
                  new
                  {
