...
{
    public class SubmitFOANoDataInsQueryHandler : IQueryHandler<SubmitFOANoDataInsQuery, List<SubmitFOAInstallation>>
    {
        ...
        public SubmitFOANoDataInsQueryHandler(
            ILogger logger,
        ...
        public List<SubmitFOAInstallation> Handle(SubmitFOANoDataInsQuery query)
        {
            ...
            try
            {
                List<SubmitFOAInstallation> executeResult = _submitInstallLog.ExecuteReadStoredProc("WBB.PKG_FIXED_ASSET_LASTMILE.p_get_ins_no_data",
                  new
                  {
