...
namespace WBBBusinessLayer.QueryHandlers.FBBWebConfigQueryHandlers
{
    ...
    public class SelectAumphurSearchFTTXHandler : IQueryHandler<SelectAmphurFttxQuery, List<DropdownModel>>
    {
        ...
        public SelectAumphurSearchFTTXHandler(ILogger logger, IEntityRepository<FBB_COVERAGE_REGION> FBB_COVERAGE_REGION,
        ...
        public List<DropdownModel> Handle(SelectAmphurFttxQuery query)
        {
            ...
            if (query.REGION_CODE != "" && query.PROVINCE != "")
            {
                ...
                GROUP_AMPHURListData = (from z2 in groupIdListZiploID
                                        where z2.RegionCode == query.REGION_CODE
            ...
            var resultUUU = (from r in _FBB_COVERAGE_REGION.Get()
            ...
            var result = (from r in _FBB_COVERAGE_REGION.Get()
                          ...
                          select new DropdownModel
                          {
                              Text = g.Key,
                              Value = g.Key
                          }).ToList().Union(resultUUU).Distinct();
