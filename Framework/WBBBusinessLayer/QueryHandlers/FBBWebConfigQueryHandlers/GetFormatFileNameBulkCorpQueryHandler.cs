...
{
    public class GetFormatFileNameBulkCorpQueryHandler : IQueryHandler<GetFormatFileNameBulkCorpQuery, List<FileFormatModelBulk>>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<FileFormatModelBulk> _PicFormat;

        public GetFormatFileNameBulkCorpQueryHandler(ILogger logger, IEntityRepository<FileFormatModelBulk> PicFormat)
        {
            _logger = logger;
        ...
        public List<FileFormatModelBulk> Handle(GetFormatFileNameBulkCorpQuery query)
        {
            try
            {
            ...
            {
                _logger.Info("Error when call GetFormatFileNameBulkCorpQueryHandler " + ex.Message);
