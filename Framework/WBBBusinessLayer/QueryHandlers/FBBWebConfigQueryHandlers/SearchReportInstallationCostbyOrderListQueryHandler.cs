...
{
    public class SearchReportInstallationCostbyOrderListQueryHandler : IQueryHandler<SearchReportInstallationCostbyOrderListQuery, ReportInstallationCostbyOrderListReturn>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<ReportInstallationCostbyOrderListModel_Binding> _objService;

        public SearchReportInstallationCostbyOrderListQueryHandler(ILogger logger, IEntityRepository<ReportInstallationCostbyOrderListModel_Binding> objService)
        {
            _logger = logger;
            _objService = objService;
        }

        public ReportInstallationCostbyOrderListReturn Handle(SearchReportInstallationCostbyOrderListQuery query)
        {
            ...
            try
            {
                ...
                var executeResult = _objService.ExecuteReadStoredProc(
                    ...
                    new
                    {
                        ...
                        //query.p_ORD_STATUS,//ใน db ไม่มี
                        query.p_ORDER_TYPE,
                        query.p_REGION,
                        query.p_FOA_FM,
                        query.p_FOA_TO,
