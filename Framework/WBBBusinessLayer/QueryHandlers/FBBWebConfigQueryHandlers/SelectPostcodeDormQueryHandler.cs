...
{
    public class SelectPostcodeDormQueryHandler : IQueryHandler<SelectPostalCodeDormQuery, List<LovModel>>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<FBB_ZIPCODE> _FBB_ZIPCODE;

        public SelectPostcodeDormQueryHandler(ILogger logger, IEntityRepository<FBB_ZIPCODE> FBB_ZIPCODE)
        {
            _logger = logger;
        ...
        public List<LovModel> Handle(SelectPostalCodeDormQuery query)
        {
