...
{
    public class SearchLastMileByDistanceOrderListQueryHandler : IQueryHandler<SearchLastMileByDistanceOrderListQuery, LastMileByDistanceOrderListReturn>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<LastMileByDistanceOrderListModel> _objService;

        public SearchLastMileByDistanceOrderListQueryHandler(ILogger logger, IEntityRepository<LastMileByDistanceOrderListModel> objService)
        {
            _logger = logger;
            _objService = objService;
        }

        public LastMileByDistanceOrderListReturn Handle(SearchLastMileByDistanceOrderListQuery query)
        {
