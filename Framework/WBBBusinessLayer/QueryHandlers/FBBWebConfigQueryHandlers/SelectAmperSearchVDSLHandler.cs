...
namespace WBBBusinessLayer.QueryHandlers.FBBWebConfigQueryHandlers
{
    ...
    public class SelectAmperSearchVDSLHandler : IQueryHandler<SelectAumperVDSLQuery, List<DropdownModel>>
    {
        ...
        public SelectAmperSearchVDSLHandler(ILogger logger, IEntityRepository<FBB_COVERAGEAREA> FBB_COVERAGEAREA,
        ...
        public List<DropdownModel> Handle(SelectAumperVDSLQuery query)
        {
            ...
            {
                Zipcode_idListData = (from z2 in ZipcodeID where z2.RegionCode == query.REGION_CODE && z2.Province == query.PROVINCE select z2.ZipcodeID).Distinct().ToList();
