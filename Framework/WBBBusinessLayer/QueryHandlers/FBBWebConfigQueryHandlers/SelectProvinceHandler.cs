...
{
    public class SelectProvinceHandler : IQueryHandler<SelectProvinceQuery, List<LovModel>>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<FBB_ZIPCODE> _FBB_ZIPCODE;

        public SelectProvinceHandler(ILogger logger, IEntityRepository<FBB_ZIPCODE> FBB_ZIPCODE)
        {
            _logger = logger;
        ...
        public List<LovModel> Handle(SelectProvinceQuery query)
        {
