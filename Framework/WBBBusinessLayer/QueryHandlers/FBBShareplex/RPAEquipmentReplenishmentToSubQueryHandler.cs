...
{
    public class RPAEquipmentReplenishmentToSubQueryHandler : IQueryHandler<RPAEquipmentReplenishmentToSubQuery, RPAEquipmentReplenishmentToSubModel>
    {
        ...
        public RPAEquipmentReplenishmentToSubQueryHandler(IEntityRepository<DataTable> repositoryDataTable, IFBBShareplexEntityRepository<ConfigurationFileQueryModel> repositoryConfigurationFileQueryModel)
        {
            _repositoryDataTable = repositoryDataTable;
            _repositoryConfigurationFileQueryModel = repositoryConfigurationFileQueryModel;
        }

        public RPAEquipmentReplenishmentToSubModel Handle(RPAEquipmentReplenishmentToSubQuery query)
        {
            ...
            try
            {
                var stringQuery = string.Format("SELECT LOV_NAME, DISPLAY_VAL, LOV_VAL1 FROM WBB.FBB_CFG_LOV WHERE LOV_TYPE = 'RPA_EQUIPMENT_TO_SUB'");
