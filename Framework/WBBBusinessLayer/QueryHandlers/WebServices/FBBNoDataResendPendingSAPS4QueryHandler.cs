...
using static WBBEntity.PanelModels.WebServiceModels.FBBNoDataResendPendingSAPS4QueryModel;

namespace WBBBusinessLayer.QueryHandlers.WebServices
{
    public class FBBNoDataResendPendingSAPS4QueryHandler : IQueryHandler<FBBNoDataResendPendingSAPS4Query, FBBNoDataResendPendingSAPS4QueryModel>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<FBBNoDataResendPendingSAPS4QueryModel> _objService;
        ...
        public FBBNoDataResendPendingSAPS4QueryHandler(ILogger logger, IEntityRepository<FBBNoDataResendPendingSAPS4QueryModel> objService,
        ...
        public FBBNoDataResendPendingSAPS4QueryModel Handle(FBBNoDataResendPendingSAPS4Query query)
        {            
            ...
            FBBNoDataResendPendingSAPS4QueryModel responseJson = new FBBNoDataResendPendingSAPS4QueryModel();
            ...
            log = InterfaceLogPayGServiceHelper.StartInterfaceLogPayG(_uow, _intfLog, "", "", "call package : P_GET_NODATA_RESEND_PENDING", "FBBNoDataResendPendingSAPS4QueryHandler", "", "", "");
            List<string> jsonResult = new List<string>();
            try
            {
                var result_get_pending_asset = _objService.ExecuteStoredProcMultipleCursor("WBB.PKG_FBBPAYG_FOA_RESEND_ORDER.P_GET_NODATA_RESEND_PENDING",
                new object[]
                    {
                        //Parameter Input
                        P_DATE_START,
                ...
                if (result_get_pending_asset != null)
                {
                    ...
                    responseJson = new FBBNoDataResendPendingSAPS4QueryModel
                    {
                        ret_code = "Success"
                    };
                    ...
                    foreach (var item in jsonResult)
                    {
                        ...
                        logItem = InterfaceLogPayGServiceHelper.StartInterfaceLogPayG(_uow, _intfLog, item, partnerMessageID, "Call GoodsMovementKAFKA", "FBBNoDataResendPendingSAPS4QueryHandler", "", "Fixed Asset", "Exs.");
                ...
                else
                {
                    ...
                    {
                        ret_code = "Error",
                        ret_msg = "Package P_GET_NODATA_RESEND_PENDING Data Return Null!"
                    };
                }
            }
            catch (Exception ex)
