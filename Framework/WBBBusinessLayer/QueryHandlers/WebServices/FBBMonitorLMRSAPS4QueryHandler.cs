...
using static WBBEntity.PanelModels.WebServiceModels.FBBMonitorLMRSAPS4QueryModel;

namespace WBBBusinessLayer.QueryHandlers.WebServices
{
    public class FBBMonitorLMRSAPS4QueryHandler : IQueryHandler<FBBMonitorLMRSAPS4Query, FBBMonitorLMRSAPS4QueryModel>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<FBBMonitorLMRSAPS4QueryModel> _objService;
        ...
        public FBBMonitorLMRSAPS4QueryHandler(ILogger logger, IEntityRepository<FBBMonitorLMRSAPS4QueryModel> objService,
        ...
        public FBBMonitorLMRSAPS4QueryModel Handle(FBBMonitorLMRSAPS4Query query)
        {            
            ...
            FBBMonitorLMRSAPS4QueryModel responseJson = new FBBMonitorLMRSAPS4QueryModel();
            ...
            log = InterfaceLogPayGServiceHelper.StartInterfaceLogPayG(_uow, _intfLog, "", "", "call package : p_monitor_lmr", "FBBMonitorLMRSAPS4QueryHandler", "", "", "");
            List<string> jsonResult = new List<string>();
            try
            {
                var result_get_pending_asset = _objService.ExecuteStoredProcMultipleCursor("WBB.PKG_FBBPAYG_FOA_RESEND_ORDER.P_MONITOR_LMR",
                new object[]
                    {
                        //Parameter Input
                        P_DATE_START,
                ...
                if (result_get_pending_asset != null)
                {
                    ...
                    responseJson = new FBBMonitorLMRSAPS4QueryModel
                    {
                        ret_code = "Success"
                    };
                    ...
                    foreach (var item in jsonResult)
                    {
                        ...
                        logItem = InterfaceLogPayGServiceHelper.StartInterfaceLogPayG(_uow, _intfLog, item, partnerMessageID, "Call GoodsMovementKAFKA", "FBBInventoryResendPendingSAPS4QueryHandler", "", "Fixed Asset", "Exs.");
                ...
                else
                {
                    ...
                    {
                        ret_code = "Error",
                        ret_msg = "Package P_GET_PENDING_ASSET Data Return Null!"
                    };
                }
            }
            catch (Exception ex)
