...
{
    public class CheckPackageDownloadSpeedQueryHandler :
        IQueryHandler<CheckPackageDownloadSpeedQuery, CheckPackageDownloadSpeedModel>
    {
        private readonly IWBBUnitOfWork _uow;
        private readonly IEntityRepository<FBB_INTERFACE_LOG> _intfLog;
        private readonly IEntityRepository<FBB_CFG_LOV> _cfgLovRepository;
        private readonly IAirNetEntityRepository<AIR_FBB_NEW_PACKAGE_MASTER> _objAirService;

        public CheckPackageDownloadSpeedQueryHandler(IWBBUnitOfWork uow,
            IEntityRepository<FBB_INTERFACE_LOG> intfLog, IEntityRepository<FBB_CFG_LOV> cfgLovRepository, IAirNetEntityRepository<AIR_FBB_NEW_PACKAGE_MASTER> objAirService)
        {
            _uow = uow;
            _intfLog = intfLog;
        ...
        public CheckPackageDownloadSpeedModel Handle(CheckPackageDownloadSpeedQuery query)
        {
            ...
            try
            {
                log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _intfLog, query, query.TransactionId, "CheckPackageDownloadSpeed", "FBBService", null, "FBB", "");
