...
{
    public class GetSendSMSDeductionPaymentHandler : IQueryHandler<GetSendSMSDeductionPaymentQuery, GetSendSMSDeductionPaymentModel>
    {
        ...
        public GetSendSMSDeductionPaymentHandler(ILogger logger, IWBBUnitOfWork uow, IEntityRepository<FBB_INTERFACE_LOG> intfLog, IEntityRepository<object> objService)
        {
            _logger = logger;
            _uow = uow;
            _intfLog = intfLog;
        ...
        public GetSendSMSDeductionPaymentModel Handle(GetSendSMSDeductionPaymentQuery query)
        {
            var log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _intfLog, query, !string.IsNullOrEmpty(query.p_mobile_no) ? query.p_mobile_no : query.p_transaction_id, "GetSendSMSDeductionPayment", "GetSendSMSDeductionPaymentHandler", null, "FBB", "");
            ...
            try
            {
                ...
                var result = _objService.ExecuteStoredProcMultipleCursor("WBB.PKG_FBB_REGISTER_PAYMENT.PROC_LIST_SEND_SMS_PAYMENT",
                    new object[]
                    {
                        p_transaction_id,
                        p_mobile_no,
                ...
                if (results.ret_code != "-1")
                {
                    ...
                    results.list_order_send_sms_payment = data1.DataTableToList<OrderSendSMSPayment>();
