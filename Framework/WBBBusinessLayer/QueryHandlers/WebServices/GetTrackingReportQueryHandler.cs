...
{
    public class GetTrackingReportQueryHandler : IQueryHandler<GetTrackingReportQuery, List<TrackingReportModel>>
    {
        private readonly ILogger _logger;
        private readonly IAirNetEntityRepository<TrackingReportModel> _trackingModel;
        private readonly IEntityRepository<FBB_INTERFACE_LOG> _intfLog;
        private readonly IWBBUnitOfWork _uow;

        public GetTrackingReportQueryHandler(ILogger logger,
            IEntityRepository<FBB_INTERFACE_LOG> intfLog,
            IWBBUnitOfWork uow,
            IAirNetEntityRepository<TrackingReportModel> trackingModel)
        {
            _logger = logger;
        ...
        public List<TrackingReportModel> Handle(GetTrackingReportQuery query)
        {
            ...
            List<TrackingReportModel> executeResult = new List<TrackingReportModel>();
            ...
            try
            {
                ...
                // 3209800123027
                executeResult = _trackingModel.ExecuteReadStoredProc("AIR_ADMIN.PKG_FBBOR005.PROC_LIST_ORD_TRACKING",
                   new
                   {
