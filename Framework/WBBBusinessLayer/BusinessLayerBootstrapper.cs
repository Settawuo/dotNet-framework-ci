...
using WBBBusinessLayer.CrossCuttingConcerns;
...
namespace WBBBusinessLayer
{
    ...
    // create a specific WBBBusinessLayer.Bootstrap project with this class.
    public static class BusinessLayerBootstrapper
    {
        ...
        public static void Bootstrap(Container container)
        {
            ...
            //container.RegisterManyForOpenGeneric(typeof(IK2QueryHandler<,>), 
            //    Assembly.GetExecutingAssembly());
            container.Register<ISkyLovHelper, SkyLovHelper>();
        }
