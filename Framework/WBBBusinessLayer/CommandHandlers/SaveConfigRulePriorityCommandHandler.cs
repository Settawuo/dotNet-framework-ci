...
{
    public class SaveConfigRulePriorityCommandHandler : ICommandHandler<SaveConfigRulePriorityCommand>
    {
        ...
        public SaveConfigRulePriorityCommandHandler(ILogger logger,
        ...
        public void Handle(SaveConfigRulePriorityCommand command)
        {
            InterfaceLogCommand log = null;
            try
            {
                log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _intfLog, command, "", "SaveConfigRulePriorityCommandHandler", "SaveConfigRulePriorityCommandHandler", "", "FBB", "WEB_CONFIG");
                ...
                eventSubObjectModel.FBB_EVENT_SUB_ARRAY = command.Lookup_param_list.Select(a => new Fbb_Event_Sub_ArrayMapping
                {
                ...
                eventSubObjectModel2.FBB_EVENT_SUB_ARRAY2 = command.Condition_list.Select(a => new Fbb_Event_Sub_ArrayMapping2
                {
                ...
                var executeResult = _objService.ExecuteStoredProc("WBB.PKG_FIXED_ASSET_PRIORITYLOOKUP.p_insert_priority",
                out paramOut,
                   new
                   {
                       p_rule_name,
            ...
            catch (Exception ex)
            {
                ...
                InterfaceLogServiceHelper.EndInterfaceLog(_uow, _intfLog, "", log, "Failed ex", ex.GetErrorMessage(), "");
        ...
        public class Fbb_Event_Sub_ArrayMapping : Oracle.ManagedDataAccess.Types.INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                OracleUdt.SetValue(con, udt, "PARAM_RULE_ID", Param_rule_id);
                OracleUdt.SetValue(con, udt, "LOOKUP_PARAMETER", Param_name);
                OracleUdt.SetValue(con, udt, "RECORD_STATUS", Param_flag);
            }
        ...
        public class EventSubObjectModel2 : Oracle.ManagedDataAccess.Types.INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                OracleUdt.SetValue(con, udt, 0, FBB_EVENT_SUB_ARRAY2);
            }

            public void ToCustomObject(OracleConnection con, object udt)
            {
                FBB_EVENT_SUB_ARRAY2 = (Fbb_Event_Sub_ArrayMapping2[])OracleUdt.GetValue(con, udt, 0);
            }
        }
        ...
        public class Fbb_Event_Sub_ArrayMapping2 : Oracle.ManagedDataAccess.Types.INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                OracleUdt.SetValue(con, udt, "CONDITION_ID", Condition_id);
                OracleUdt.SetValue(con, udt, "CONDITION_PARAMETER", Condition_parameter);
                OracleUdt.SetValue(con, udt, "OPERATOR", Conditaion_operator);
                OracleUdt.SetValue(con, udt, "VALUE", Conditaion_value);
                OracleUdt.SetValue(con, udt, "RECORD_STATUS", Condition_flag);
            }
