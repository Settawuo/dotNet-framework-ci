...
{
    public class ChangeContactMobileCommandHandler : ICommandHandler<ChangeContactMobileCommand>
    {
        ...
        public ChangeContactMobileCommandHandler(ILogger logger
        ...
        public void Handle(ChangeContactMobileCommand command)
        {
            InterfaceLogCommand log = null;
            log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _interfaceLog, command, command.OrderNo, "ChangeMobileContactCommand", "ChangeContact", null, "FBB", "");
            try
            {
                ...
                var executeResult = _objService.ExecuteStoredProc("WBB.PKG_FBBOR004.PROC_UPDATE_CONTACT_MOBILE",
                    out paramOut,
                       new
                       {
                           p_order_no = command.OrderNo,
                           p_new_contact_mobile = command.NewMobileContact,
                ...
                executeResult = _objAirService.ExecuteStoredProc("AIR_ADMIN.PKG_AIROR905.UPDATE_CONTACT_MOBILE",
                    out paramOut,
                       new
                       {
                           p_order_no = command.OrderNo,
