...
{
    public class UpdateFbssFOAConfigTblCommandHandler : ICommandHandler<UpdateFbssFOAConfigTblCommand>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<string> _objService;

        public UpdateFbssFOAConfigTblCommandHandler(
            ILogger logger,
        ...
        public void Handle(UpdateFbssFOAConfigTblCommand command)
        {
