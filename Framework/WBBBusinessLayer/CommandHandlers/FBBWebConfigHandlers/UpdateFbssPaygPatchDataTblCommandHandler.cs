...
{
    public class UpdateFbssPaygPatchDataTblCommandHandler : ICommandHandler<UpdateFbssPaygPatchDataTblCommand>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<string> _objService;

        public UpdateFbssPaygPatchDataTblCommandHandler(
            ILogger logger,
        ...
        public void Handle(UpdateFbssPaygPatchDataTblCommand command)
        {
            UpdateFbssPaygPatchDataTbl_Result result = new UpdateFbssPaygPatchDataTbl_Result();
