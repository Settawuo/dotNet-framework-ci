...
{
    public class ReportInstallationCostbyOrderRecalByRevampCommandHandler : ICommandHandler<ReportInstallationRecalByRevampCommand>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<ReportInstallationReturnCurRecalRevampModel> _objService;
        private readonly IEntityRepository<FBB_HISTORY_LOG> _historyLog;
        private readonly IWBBUnitOfWork _uow;
        public ReportInstallationCostbyOrderRecalByRevampCommandHandler(ILogger ILogger, IEntityRepository<ReportInstallationReturnCurRecalRevampModel> objService, IEntityRepository<FBB_HISTORY_LOG> historyLog, IWBBUnitOfWork uow)
        {
            _logger = ILogger;
        ...
        public void Handle(ReportInstallationRecalByRevampCommand command)
        {
            ...
            try
            {
                    ...
                    FBBPAYG_RECAL_LIST =
                        command.p_recal_access_list.Select(
                           a => new FBBPAYG_RECAL_LISTMapping
                           {
                               ...
                               RECAL_TOTAL_COST = a.RECAL_TOTAL_COST,
                               DISTANCE = a.DISTANCE,
                               REASON = a.REASON,
                               REMARK = a.REMARK
                ...
                var test = _objService.ExecuteReadStoredProc("WBB.PKG_PAYG_INSTALL_COST_RPT.p_recal_revamp",
                    new
                    {
                        p_recal_access_list,
                ...
                if (command.ret_code != "0")
                {
                    ...
                    historyLog.APPLICATION = "ReportInstallation Re-Cal Revamp";
        ...
        public class FBBPAYG_RECAL_LISTMappingOracleTypeMappingFactory : IOracleCustomTypeFactory
        {
