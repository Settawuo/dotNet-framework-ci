...
{
    public class SaveLeavemessagePNCommandHandler : ICommandHandler<SaveLeavemessagePNCommand>
    {
        ...
        public SaveLeavemessagePNCommandHandler(ILogger logger,
        ...
        public void Handle(SaveLeavemessagePNCommand command)
        {
            InterfaceLogCommand log = null;
            try
            {
                log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _intfLog, command, command.p_contact_mobile_no, "SaveLeavemessagePNCommandHandler", "SaveLeavemessagePNCommandHandler", command.p_contact_mobile_no, "FBB", "WEB");
