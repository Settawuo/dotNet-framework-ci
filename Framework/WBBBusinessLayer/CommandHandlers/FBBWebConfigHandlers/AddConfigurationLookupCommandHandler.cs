...
{
    public class AddConfigurationLookupCommandHandler : ICommandHandler<AddConfigurationLookupCommand>
    {
        ...
        public AddConfigurationLookupCommandHandler(ILogger logger,
        ...
        public void Handle(AddConfigurationLookupCommand command)
        {
            InterfaceLogCommand log = null;
            try
            {
                log = InterfaceLogServiceHelper.StartInterfaceLog(_uow, _intfLog, command, "", "AddConfigurationLookupCommandHandler", "AddConfigurationLookupCommandHandler", "", "FBB", "WEB_CONFIG");
                ...
                var executeResult = _objService.ExecuteStoredProc("wbb.pkg_fixed_asset_prioritylookup.p_insert_lookup",
                out paramOut,
                   new
                   {
                       //List
        ...
        public class LookupHeaderObjectModel : INullable, IOracleCustomType
        {
            ...
            {
                OracleUdt.SetValue(con, udt, 0, lookup_header_list);
            }

            public void ToCustomObject(OracleConnection con, object udt)
            {
                lookup_header_list = (WBB_Payg_Lookup_Header_PackageOracleTypeMapping[])OracleUdt.GetValue(con, udt, 0);
            }
        }
        ...
        public class WBB_Payg_Lookup_Header_PackageOracleTypeMapping : INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                OracleUdt.SetValue(con, udt, "PARAMETER_NAME", parameter_name);
                OracleUdt.SetValue(con, udt, "LOOKUP_FLAG", lookup_flag);
                OracleUdt.SetValue(con, udt, "PARAMETER_VALUE", parameter_value);
            }
        ...
        public class LookupObjectModel : INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                OracleUdt.SetValue(con, udt, 0, p_lookup_list);
            }

            public void ToCustomObject(OracleConnection con, object udt)
            {
                p_lookup_list = (fbbpayg_insert_lookup_list_Mapping[])OracleUdt.GetValue(con, udt, 0);
            }
        }
        ...
        public class fbbpayg_insert_lookup_list_Mapping : INullable, IOracleCustomType
        {
            ...
            public void FromCustomObject(OracleConnection con, object udt)
            {
                ...
                OracleUdt.SetValue(con, udt, "LOOKUP_STATUS", lookup_status);
                OracleUdt.SetValue(con, udt, "LOOKUP_HEADER_LIST", lookup_header_list);
            }
