...
{
    public class LoadFileSimCommandHandler : ICommandHandler<LoadFileSimCommand>
    {
        ...
        public LoadFileSimCommandHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public void Handle(LoadFileSimCommand command)
        {
