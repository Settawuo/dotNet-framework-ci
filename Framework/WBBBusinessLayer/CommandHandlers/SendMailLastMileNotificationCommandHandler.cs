...
{
    public class SendMailLastMileNotificationCommandHandler : ICommandHandler<SendMailLastMileNotificationCommand>
    {
        ...
        public SendMailLastMileNotificationCommandHandler(ILogger logger,
            IWBBUnitOfWork uow,
        ...
        public async void Handle(SendMailLastMileNotificationCommand command)
        {
            ...
            try
            {
                ...
                newMailLog.PROCESS_NAME = "Sended LastMile";
