...
{
    public class ReportActiveCommandHandler : ICommandHandler<ReportActiveCommand>
    {
        private readonly ILogger _logger;
        private readonly IEntityRepository<string> _objService;

        public ReportActiveCommandHandler(ILogger logger, IEntityRepository<string> objService)
        {
            _logger = logger;
            _objService = objService;
        }

        public void Handle(ReportActiveCommand command)
        {
            try
            {
