...
namespace WBBBusinessLayer.ServiceHelper
{
    ...
    {
        public static string _nasLoginType;
        public static string _nasProvider;
        ...
        public Impersonator(string username, string domainOrServerName, string password, bool useDomain = true)
        {
            ...
            logonResult = LogonUser(username, domainOrServerName, password, int.Parse(_nasLoginType), int.Parse(_nasProvider), ref userToken);
